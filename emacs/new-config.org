...
#+begin_src emacs-lisp
  ...
  (use-package dired-hide-dotfiles
    ...
    :init
    ;; Hooks
    (add-hook 'dired-mode-hook #'dired-hode-dotfiles-mode)
    (evil-collection-define-key 'normal 'dired-mode-map
...
(use-package doom-themes
  ...
  (load-theme 'doom-one t))  ;; Ones I liked and used: doom-one, doom-dark+, doom-solarized-light
#+end_src
  ...
  (if (string= system-name "Duys-MBP.home")
    ...
    (if (string= system-name "NL5CG1462QH6")
        (setq duy/default-font "FiraMono Nerd Font Mono"
              duy/variable-font "FiraMono Nerd Font Mono")
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (org-agenda-tags-column "auto")      ; tags right-aligned in org agenda
